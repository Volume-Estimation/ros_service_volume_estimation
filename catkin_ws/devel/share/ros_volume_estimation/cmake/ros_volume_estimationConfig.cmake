...
if(ros_volume_estimation_CONFIG_INCLUDED)
  return()
endif()
set(ros_volume_estimation_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(ros_volume_estimation_SOURCE_PREFIX /home/steven/projects/ros_service_volume_estimation/catkin_ws/src/ros_volume_estimation)
  set(ros_volume_estimation_DEVEL_PREFIX /home/steven/projects/ros_service_volume_estimation/catkin_ws/devel)
  set(ros_volume_estimation_INSTALL_PREFIX "")
  set(ros_volume_estimation_PREFIX ${ros_volume_estimation_DEVEL_PREFIX})
else()
  set(ros_volume_estimation_SOURCE_PREFIX "")
  set(ros_volume_estimation_DEVEL_PREFIX "")
  set(ros_volume_estimation_INSTALL_PREFIX /home/steven/projects/ros_service_volume_estimation/catkin_ws/install)
  set(ros_volume_estimation_PREFIX ${ros_volume_estimation_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ros_volume_estimation' is deprecated")
...
set(ros_volume_estimation_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/steven/projects/ros_service_volume_estimation/catkin_ws/devel/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(ros_volume_estimation_INCLUDE_DIRS "")
  set(_include_dirs "/home/steven/projects/ros_service_volume_estimation/catkin_ws/devel/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'ROS User <2654625005@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${ros_volume_estimation_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ros_volume_estimation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ros_volume_estimation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/steven/projects/ros_service_volume_estimation/catkin_ws/src/ros_volume_estimation/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ros_volume_estimation_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND ros_volume_estimation_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND ros_volume_estimation_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT ros_volume_estimation_NUM_DUMMY_TARGETS)
      set(ros_volume_estimation_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ros_volume_estimation::wrapped-linker-option${ros_volume_estimation_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ros_volume_estimation_NUM_DUMMY_TARGETS "${ros_volume_estimation_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ros_volume_estimation::wrapped-linker-option${ros_volume_estimation_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ros_volume_estimation_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND ros_volume_estimation_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/steven/projects/ros_service_volume_estimation/catkin_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(ros_volume_estimation_LIBRARY_DIRS ${lib_path})
      list(APPEND ros_volume_estimation_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ros_volume_estimation'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ros_volume_estimation_LIBRARIES ${lib})
    endif()
  endif()
...
set(ros_volume_estimation_EXPORTED_TARGETS "ros_volume_estimation_generate_messages_cpp;ros_volume_estimation_generate_messages_eus;ros_volume_estimation_generate_messages_lisp;ros_volume_estimation_generate_messages_nodejs;ros_volume_estimation_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ros_volume_estimation_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;rospy;std_msgs;sensor_msgs;geometry_msgs;pcl_ros;pcl_conversions;message_runtime")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 ros_volume_estimation_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ros_volume_estimation_dep}_FOUND)
      find_package(${ros_volume_estimation_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ros_volume_estimation_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ros_volume_estimation_INCLUDE_DIRS ${${ros_volume_estimation_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ros_volume_estimation_LIBRARIES ${ros_volume_estimation_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ros_volume_estimation_dep}_LIBRARIES})
  _list_append_deduplicate(ros_volume_estimation_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ros_volume_estimation_LIBRARIES ${ros_volume_estimation_LIBRARIES})

  _list_append_unique(ros_volume_estimation_LIBRARY_DIRS ${${ros_volume_estimation_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(ros_volume_estimation_EXPORTED_TARGETS ${${ros_volume_estimation_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "ros_volume_estimation-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ros_volume_estimation_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
